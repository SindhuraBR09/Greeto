...
<br><br>
<?php
echo "<center><div align=\"center\" style=\"background-color:white;width:250px;padding:20px; \" ><img src=\"$img\" height=200px width=200px style=\"border: 2px solid #a1a1a1;
    border-radius: 150px;\">";
...
<div align="center">
<iframe src= "http://localhost/greeto/information.php" name="Frameid" width=600px height=600px frameborder="0">
</iframe>
</div>
